This is a roulette wheel simulator which will generate the results of having played 20 spins using different betting strategies to a data file. The data itself is meant to demonstrate the statistical risk/reward variances seen in gambling when for example, betting on one number which pays 35 to 1 as opposed to the stability of just betting on black or red which pay 1:1.
